...
console.log('isALetter() => ', isALetter(10));
console.log('isALetter => ', isALetter("FJ"));
console.log('isALetter ? ', isALetter(1203003));
console.log('isALetter ? ', isALetter("120b3003"));
console.log('isALetter ? ', isALetter("1203003b"));
console.log('isALetter ? ', isALetter("1203003b"));
// isALetter(a)
//